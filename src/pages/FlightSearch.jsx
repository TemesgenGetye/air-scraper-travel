        ...
        const mockFlights = [
          {
            ...
            flightNumber: "DL1234",
            departureAirport: originSkyId || origin || "JFK",
            arrivalAirport: destinationSkyId || destination || "LAX",
            departureTime: "08:30",
            arrivalTime: "11:45",
            duration: "3h 15m",
            stops: 0,
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-8 text-center">
            <div className="flex flex-col items-center justify-center">
              ...
              <Link to="/" className="px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800">
                Return to Home
              </Link>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-lg p-6 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            ...
            <Link to="/" className="mt-4 md:mt-0 px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800">
              Modify Search
            </Link>
          </div>
                    ...
                    >
                      <div className="flex flex-col md:flex-row justify-between">
                        ...
                        <div className="flex flex-col items-end justify-center mt-4 md:mt-0">
                          ...
                          <Link
                            to={`/flights/details/${flight.id}?origin=${searchParams.get("origin")}&destination=${searchParams.get("destination")}&departDate=${searchParams.get("departDate")}&returnDate=${searchParams.get("returnDate") || ""}`}
